      ...
      child: Drawer(    
           child: ListView(
            ...
            Flexible(
             ...
             ListTile(
              onTap: () {
                  nextScreenRemoveUntil(context, LecturerProfile());
              },
              contentPadding: const EdgeInsets.symmetric(horizontal:20, vertical: 5),
             ...
             ListTile(
               onTap: () {
                  nextScreenRemoveUntil(context, Slot());
               }, 
               contentPadding: const EdgeInsets.symmetric(horizontal: 20, vertical: 5),
               ...
               title:  Text(
                ...
                style: TextStyle(
                 ...
                 ListTile(
               onTap: () {
                  nextScreenRemoveUntil(context, Appointment());
               }, 
               contentPadding: const EdgeInsets.symmetric(horizontal: 20, vertical: 5),
              ...
              ListTile(
               onTap: () {
                 nextScreenRemoveUntil(context, AttendanceAppointment());
               }, 
               contentPadding: const EdgeInsets.symmetric(horizontal: 20, vertical: 5),
              ...
              ListTile(
               onTap: () {
                   nextScreenRemoveUntil(context, LecturerChat());
               }, 
               contentPadding: const EdgeInsets.symmetric(horizontal: 20, vertical: 5),
